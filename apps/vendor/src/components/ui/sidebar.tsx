...
const SIDEBAR_COOKIE_NAME = "vendor_sidebar_state";
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="inset-y-0 left-0 h-dvh w-(--sidebar-width) max-w-[calc(100vw-2rem)] gap-0 rounded-none border-sidebar-border bg-sidebar p-0 text-sidebar-foreground [&>button]:text-sidebar-foreground [&_[data-sidebar=header]]:pr-12"
          style={
            {
        ...
        >
          <div className="sr-only">
            ...
            <SheetDescription>Enlaces principales del panel.</SheetDescription>
          </div>
